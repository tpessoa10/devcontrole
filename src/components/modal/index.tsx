...
export function ModalTicket() {
    ...
    return (
        <div onClick={handleModalClick} className="absolute w-full border-4 bg-gray-900/80 min-h-screen">
            <div className="absolute inset-0 flex items-center justify-center">
                <div ref={modalRef} className="bg-white border-2 shadow-lg w-4/5 md:1/2 max-w-2xl p-3 rounded">
                    <div className="flex items-center justify-between mb-4">
                        <h1 className="font-bold text-lg md:text-2xl">Detalhes do Chamado</h1>
                        <button onClick={handleModalVisible} className="bg-red-500 p-1 text-white rounded">
                            Fechar
                        </button>
                    </div>
